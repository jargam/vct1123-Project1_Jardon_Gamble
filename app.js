...
var wrapper_Divs = document.getElementsByClassName(wrapper_Divs);
...
for (i=0; i < sections.lenght; i++) {
    ...
    artistList += <tr><td>Album Image:</td><td>” + allArtists[i].albumImg + “</td></tr>”;
    artistList += <tr><td>Bio:</td><td>” + allArtists[i].bio + “</td></tr>”;
    artistList += </table>
};
